...
class BalanceSheetGenerator {
    ...
    public function getGoldLoanSummary() {
        $query = "SELECT 
    ...
    public function getRepledgeSummary() {
        $query = "SELECT 
    ...
    public function calculatePotentialNetIncome() {
        $expenseSummary = $this->getExpenseSummary();
        $goldLoanSummary = $this->getGoldLoanSummary();
        $repledgeSummary = $this->getRepledgeSummary();
