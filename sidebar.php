...
<li class="nav-item">
              <a class="nav-link" href="generate_cover_label.php">
              <i class="fa fa-check-square-o" aria-hidden="true"></i>
                <span class="menu-title">Cover Label</span>
              </a>
            </li>
 <li class="nav-item">
...
<li class="nav-item">
		 ...
		 <li class="nav-item">
              <a class="nav-link" href="search_repledge_loan.php">
              <i class="fa fa-refresh" aria-hidden="true"></i>
                <span class="menu-title">Search Repledge</span>
              </a>
            </li>
            <li class="nav-item">
...
<li class="nav-item">
                    ...
                    <a class="nav-link" href="pronote1.php">
<i class="fa fa-window-close-o" aria-hidden="true"></i>
                <span class="menu-title"> Apply for loan</a>
                  </li>
<li class="nav-item">
                
                    <a class="nav-link" href="pronote2.php">
<i class="fa fa-window-close-o" aria-hidden="true"></i>
                <span class="menu-title"> Loan Payment
</a>
                  </li>
<li class="nav-item">
              <a class="nav-link" href="loan_from_relatives.php">
              <i class="fa fa-check-square-o" aria-hidden="true"></i>
                <span class="menu-title">Loan From Relatives </span>
              </a>
            </li>
<li class="nav-item">
              <a class="nav-link" href="close_deposit.php">
              <i class="fa fa-check-square-o" aria-hidden="true"></i>
                <span class="menu-title">Close Loan From Relatives </span>
              </a>
            </li>
